 ...
 * @author PERSONAL
 */
public class FormRekapPrisensiPeg extends javax.swing.JFrame implements Master {
    String sql;
    Statement st;
    Connection con;
    ResultSet rs; 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("FORM REKAP PRESENSI PEGAWAI");
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        ...
        txtJabatan.setText(FormLogin.txtjabatan.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormRekapPrisensiPeg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormRekapPrisensiPeg().setVisible(true);
            }
        });
    } 
